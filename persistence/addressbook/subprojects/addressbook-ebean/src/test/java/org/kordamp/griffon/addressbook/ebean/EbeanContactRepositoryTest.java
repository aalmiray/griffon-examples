...
public class EbeanContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-ebean")
    @Named("application-ebean")
    public static class EbeanTestModule extends ApplicationEbeanModule {
        @Override
