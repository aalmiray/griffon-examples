...
public class Db4oContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-db4o")
    @Named("application-db4o")
    public static class Db4oTestModule extends ApplicationDb4oModule {
        @Override
