...
public class Sql2oContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-sql2o")
    @Named("application-sql2o")
    public static class Sql2oTestModule extends ApplicationSql2oModule {
        @Override
