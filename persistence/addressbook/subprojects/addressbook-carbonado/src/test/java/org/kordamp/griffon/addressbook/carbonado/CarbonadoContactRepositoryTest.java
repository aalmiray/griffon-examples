...
public class CarbonadoContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-carbonado")
    @Named("application-carbonado")
    public static class CarbonadoTestModule extends ApplicationCarbonadoModule {
        @Override
