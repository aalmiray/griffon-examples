...
public class SpringContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-spring")
    @Named("application-spring")
    public static class SpringTestModule extends ApplicationSpringModule {
        @Override
