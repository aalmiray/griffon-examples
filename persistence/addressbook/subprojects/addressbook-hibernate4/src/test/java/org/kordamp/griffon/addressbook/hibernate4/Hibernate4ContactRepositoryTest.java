...
public class Hibernate4ContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-hibernate4")
    @Named("application-hibernate4")
    public static class Hibernate4TestModule extends ApplicationHibernate4Module {
        @Override
