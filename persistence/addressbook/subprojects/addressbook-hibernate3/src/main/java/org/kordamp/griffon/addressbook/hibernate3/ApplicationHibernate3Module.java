...
public class ApplicationHibernate3Module extends AbstractModule {
    @Override
    protected void doConfigure() {
        bindContactRepository();
        bindHibernate3Bootstrap();
    }

    protected void bindContactRepository() {
        bind(ContactRepository.class)
            .to(Hibernate3ContactRepository.class)
            .asSingleton();
    }

    protected void bindHibernate3Bootstrap() {
        bind(Hibernate3Bootstrap.class)
            .to(ContactsHibernate3Bootstrap.class)
            .asSingleton();
    }
}