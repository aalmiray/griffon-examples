...
public class JdbiContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-jdbi")
    @Named("application-jdbi")
    public static class JdbiTestModule extends ApplicationJdbiModule {
        @Override
