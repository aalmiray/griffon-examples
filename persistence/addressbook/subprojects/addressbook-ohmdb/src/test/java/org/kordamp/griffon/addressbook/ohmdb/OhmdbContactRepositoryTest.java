...
public class OhmdbContactRepositoryTest extends AbstractContactRepositoryTest {
    @DependsOn("application")
    @Evicts("application-ohmdb")
    @Named("application-ohmdb")
    public static class OhmdbTestModule extends ApplicationOhmdbModule {
        @Override
